  ...
  screens: [
    ...
    },
    {
      ...
      fieldValues: {
        ...
        form_field_count: '4',
        f1_label: 'Item', f1_type: 'dropdown', f1_options: 'Nasi Lemak, Karipap, Teh O, Teh Tarik, Roti Canai, Mee Goreng, Nasi Goreng, Lain-lain',
        f2_label: 'Kuantiti', f2_type: 'number', f2_options: '',
        f3_label: 'Harga seunit (RM)', f3_type: 'number', f3_options: '',
        f4_label: 'Nota tambahan', f4_type: 'text', f4_options: '',
        hint: '', q1: '', q2: '', q3: '', q4: '',
        button_label: 'Rekod',
        ai_instruction: 'ask:Rekod jualan ini:\nItem: {{form_f1}}\nKuantiti: {{form_f2}}\nHarga seunit: RM{{form_f3}}\nNota: {{form_f4}}\n\nSahkan item, kirakan jumlah (kuantiti x harga), dan beri ringkasan ringkas.',
      },
      disabledWidgets: [],
      description: 'SCREEN: Rekod Jualan | FUNCTION: Form to record daily sales with item, quantity, and price | INPUTS: form_f1, form_f2, form_f3, form_f4 | TRIGGERS: rekod, jualan, jual, nasi lemak, karipap, teh, berapa jumlah, hari ini',
      prefillHints: { item: 'form_f1', kuantiti: 'form_f2', harga: 'form_f3', nota: 'form_f4' },
    },
    {
      id: 'kira_untung', title: 'Kira Untung', isHome: false, gridColumns: 2, screenIcon: '\u{1F4B5}',
      ...createScreen('calculator', {
        field_a_label: 'Jumlah Jualan (RM)',
        field_a_hint: 'cth. 500',
        field_b_label: 'Jumlah Kos (RM)',
        field_b_hint: 'cth. 200',
        slider_label: 'Cukai (%)',
        slider_min: '0',
        slider_max: '15',
      ...
      description: 'SCREEN: Kira Untung | FUNCTION: Calculate net profit from revenue minus costs with optional tax | INPUTS: calc_a, calc_b, calc_rate | TRIGGERS: untung, profit, kira, berapa untung, jualan tolak kos, margin',
    ...
    },
    {
      ...
      fieldValues: {
        ...
        hint: 'Contoh: Berapa untung bulan ini?',
      ...
      disabledWidgets: [],
      description: 'SCREEN: Tanya Kira | FUNCTION: General Q&A about warung business management | INPUTS: user_text | TRIGGERS: tanya, soalan, macam mana, apa, kenapa, berapa, nasihat, tips',
