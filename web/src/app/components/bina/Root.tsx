...
export default function Root() {
  ...
  return (
    <div className="flex h-[100dvh] w-full overflow-hidden">
      <aside
        className="relative flex flex-col justify-between items-stretch p-4 transition-all duration-200 overflow-hidden"
      ...
      >
        ...
        {/* Top: Logo */}
        <div className={`flex ${collapsed ? 'items-center justify-center' : 'items-center px-3 gap-3'} pt-2`}>
          <div
        ...
        <div className="flex flex-col gap-2">
          {!collapsed && (
            <div className="px-3">
              <div className="rounded-lg px-3 py-2.5 flex flex-col items-center gap-1.5" style={{ background: 'rgba(255,255,255,0.08)' }}>
                <img src="/deepmind-logo.png" alt="DeepMind" width="32" height="32" className="shrink-0 rounded-full" />
